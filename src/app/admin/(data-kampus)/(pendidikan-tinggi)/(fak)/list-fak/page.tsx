...
import { useFakTable } from "@/lib/hooks/data-kampus/perguruan-tinggi/fak/useFakTable";
import type { FakultasItem } from "@/lib/services/data-kampus/pendidikan-tinggi/fak/type";
	...
	return (
		<div className="min-h-screen bg-slate-50 p-4 md:p-8 overflow-hidden">
			...
			<div className="mb-6 md:mb-8 slide-in-left">
				...
				<p className="mt-1 text-sm md:text-base text-slate-600 hover:text-slate-800 transition-colors duration-200">Kelola data fakultas</p>
			</div>
					...
					<thead>
							<tr className="bg-indigo-600 text-white">
								...
								<th className="px-3 md:px-6 py-3 md:py-4 text-left text-xs md:text-sm font-semibold tracking-wider group hover:bg-indigo-700 transition-colors duration-200">
									<div className="flex items-center gap-1 md:gap-2">
										...
										<span className="group-hover:translate-x-1 transition-transform duration-200">Nama Fakultas</span>
									</div>
								</th>
								<th className="px-3 md:px-6 py-3 md:py-4 text-left text-xs md:text-sm font-semibold tracking-wider group hover:bg-indigo-700 transition-colors duration-200">
									<div className="flex items-center gap-1 md:gap-2">
						...
						<tbody className="divide-y divide-slate-100">
							{isLoading ? (
								...
								data?.data.data.map((row: FakultasItem, idx: number) => (
									<tr
										key={row.kode_fakultas}
									...
									>
										...
										<td className="px-3 md:px-6 py-3 md:py-4 text-right">
											<div className="inline-flex items-center gap-2">
												<Link
													href={`/siakad/admin/fakultas/${row.kode_fakultas}`}
												...
												<button
													onClick={() => {
														if (confirm('Hapus fakultas ini?')) {
															console.log('delete', row.kode_fakultas);
